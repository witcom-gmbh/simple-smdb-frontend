...
export class ServiceItemService {
  ...
  getChildrenMultiplicity(serviceItemId: number):Observable<Array<ServiceItemMultiplicityDto>>{
      return this.svcInstantiation.ServiceInstantiationGetChildrenServiceItemMultiplicitiesV2(serviceItemId);
  }
  ...
  */
  ...
  modifyServiceItemMultiplicity(serviceItemId:number,childAssocName:string,multiplicity:number): Observable<ServiceItemMultiplicityDto>{
      ...
      let params = <ServiceInstantiationV2Service.ServiceInstantiationModifyServiceItemMultiplicityV2Params>{
      ...
      return this.svcInstantiation.ServiceInstantiationModifyServiceItemMultiplicityV2(params);
